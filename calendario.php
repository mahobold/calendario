            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="eventForm">
                        ...
                        <input type="hidden" id="eventStart" name="data">
                    </form>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        select: function(info) {
            ...
            document.getElementById('eventStart').value = info.startStr.split('T')[0]; // Use apenas a data
    ...
    var data = document.getElementById('eventStart').value;
